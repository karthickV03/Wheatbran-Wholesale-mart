...
class Category(models.Model):
    slug = models.CharField(max_length=40, null=False, blank=False)
...
class Product(models.Model):
    ...
    description = models.TextField(max_length=500, null=False, blank=False)
    original_price = models.FloatField(max_length=5, null=False, blank=False)
    selling_price = models.FloatField(max_length=5, null=False, blank=False)
    status = models.BooleanField(default=False, help_text="0=default, 1=hidden")
    trending = models.BooleanField(default=False, help_text="0=default, 1=Trending")
    ...
    meta_keywords = models.CharField(max_length=50, null=False, blank=False)
    meta_description = models.TextField(max_length=100, null=False, blank=False)
    created_at = models.DateTimeField(max_length=5, auto_now_add=True)
...
class Order(models.Model):
    ...
    payment_mode = models.CharField(max_length=25, null=False)
    ...
    status = models.CharField(max_length=25, choices=orderstatuses, default='Pending')
